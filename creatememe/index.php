...
function initializeCreateMemePage(): array
{
    session_name('auth');
    session_start();
...
[$balance, $login] = initializeCreateMemePage();
?>
...
<head>
    <meta charset="utf-8">
    <link href="/creatememe/style.css" rel="stylesheet">
    <script src="/creatememe/script.js" defer></script>
...
<div class="page">
    <nav class="nav">
        ...
        <a href="/<?= htmlspecialchars($login) ?>" class="nav_item">
            <img src="/src/img/profile.svg" alt="Profile">
        </a>
        <div class="nav_balance">
            <span class="balance_value"><?= htmlspecialchars($balance) ?></span>
